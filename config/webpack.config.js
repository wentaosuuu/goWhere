...
// ].filter(Boolean),
    output: {
      ...
      filename: isEnvProduction
        ...
        : isEnvDevelopment && 'static/js/[name].js', // 这里要把bundle.js改成[name].js 不然第二个页面加载不了 11/04/2020
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            ...
            filename: 'index.html', // 新加的, 要指定filename
            chunks: ['index'] // 新加的
          },
          isEnvProduction
            ? {
...
// https://github.com/facebook/create-react-app/issues/5358
      ...
      new ManifestPlugin({
        ...
        generate: (seed, files, entrypoints) => {
          ...
          // 07/04/2020 因为我们改变成4个页面. 所以这里要做一个循环. 我也不是很懂. 网上复制粘贴过来的
          let entrypointFiles = [];
