...
const ScheduleRow = memo(function ScheduleRow(props) {
  ...
  return (
    <li>
      <div className={classenames('icon', {
      ...
      <div className={classenames('row', {
        grey: beforeDepartStation || afterArriveStation,
      })}>
        <span className={classenames('station', {
          red: isArriveStation || isDepartStation
        })}>
          {station}
        </span>
        <span className={classenames('arrtime', {
          red: isArriveStation,
        })}>
          {isStartStation ? '始发站' : arriveTime}
        </span>
        <span className={classenames('deptime', {
          red: isDepartStation,
        })}>
